...
class GhostBody(AgentBody):
    def __init__(self, x, y, cell, color=ColorConfig.GHOST1):
        ...
        self._normal_velocity = AgentBody.VELOCITY * 1.5
            ...
            for obj in l:
                if obj.is_body:
                    ...
                    if isinstance(ag, GhostAgent) and ag.scared:
                        ColorConfig.reward.append([50])
                        print("REWARD", ColorConfig.reward)
...
class KeyboardAgent(PacmanAgent):
    ...
    def next_action(self):
        print("MOVELIST", KeyboardAgent.moveList)
        if random.randint(1,4) == 1:
            ColorConfig.reward.append([0])
            print("REWARD", ColorConfig.reward)

            KeyboardAgent.moveList.append([1])
            print("MOVELIST", KeyboardAgent.moveList)
            ...
            KeyboardAgent.moveList.append([2])
            print("MOVELIST", KeyboardAgent.moveList)
            ...
            KeyboardAgent.moveList.append([3])
            print("MOVELIST", KeyboardAgent.moveList)
            ...
            KeyboardAgent.moveList.append([4])
            print("MOVELIST", KeyboardAgent.moveList)
    ...
    def on_draw(self):
        ...
        if self.world.game_over:
            if self.world.player_win:
                ...
                X = np.array(KeyboardAgent.moveList)
                print("X" + X)

                Y = np.array(ColorConfig.reward)
                print("Y" + Y)
